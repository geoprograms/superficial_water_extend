...
SOURCES = \
	__init__.py \
	superficial_water_extend.py superficial_water_extend_dialog.py

PLUGINNAME = superficial_water_extend

PY_FILES = \
	__init__.py \
	superficial_water_extend.py superficial_water_extend_dialog.py

UI_FILES = superficial_water_extend_dialog_base.ui
...
QGISDIR=C:\Users\Manuel Guerra\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
